...
def parse_options(argv):
    ...
    optional.add_option('--with_parents',  dest='with_parents', action='store_false', help='parents included in sequencing data', default=False)
    ...
    optional.add_option('--trust-gaTK', dest='trust_gatk', action='store_false', help='Override non-zero counts for homoczygous gatk calls', default=False)
    ...
    optional.add_option('--min_segr_pv',dest='min_segr_pv',type='int',help='Minimal allowed segregation p-value', default=0)
    optional.add_option('--chrom_size',dest='chrom_size',type='int',help='Chromsome Size if running on a single chromosome', default=0)
    ...
    optional.add_option('--opt_eps', dest='opt_eps', action='store_false', help='verbosity', default=False)
    optional.add_option('--opt_recombination', dest='opt_recombination', action='store_false', help='verbosity', default=False)
